...
def test_new_product_1(product_dict_1):
    existing_products = [
        Product(
            name="Samsung Galaxy S23 Ultra", description="256GB, Серый цвет, 200MP камера", price=170000.0, quantity=2
        )
    ]
...
@pytest.mark.parametrize(
    "new_price, user_response, expected_final_price, expected_message",
    [
